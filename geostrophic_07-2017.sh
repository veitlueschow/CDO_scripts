...
# upper
/pf/zmaw/m214003/local/bin/cdo -mulc,-1 -div -sub -shifty,+1,cyclic $p $p -shifty,+1,cyclic -mul $ftwov $dlyp wup.nc
# lower
...
# right
/pf/zmaw/m214003/local/bin/cdo -div -sub -shiftx,-1,cyclic $p $p -mul $ftwou $dlxp wright.nc
