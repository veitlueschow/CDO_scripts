...
/pf/zmaw/m214003/local/bin/cdo -mulc,-6856.71326 -div -div -sub -shiftx,+1,cyclic -add box_po.nc -mulc,9.81 box_zo.nc -add box_po.nc -mulc,9.81 box_zo.nc box_dlxu.nc -sin -mulc,0.017453 box_alat.nc box_vg1.nc #up right
/pf/zmaw/m214003/local/bin/cdo -mulc,6856.71326 -div -div -sub -shiftx,-1,cyclic -add box_po.nc -mulc,9.81 box_zo.nc -add box_po.nc -mulc,9.81 box_zo.nc box_dlxu.nc -sin -mulc,0.017453 box_alat.nc box_vg-1.nc #up left
...
/pf/zmaw/m214003/local/bin/cdo -mulc,-6856.71326 -div -div -sub -shifty,+1,cyclic -add box_po.nc -mulc,9.81 box_zo.nc -add box_po.nc -mulc,9.81 box_zo.nc box_dlyv.nc -sin -mulc,0.017453 box_alat.nc box_ug1.nc
/pf/zmaw/m214003/local/bin/cdo -mulc,6856.71326 -div -div -sub -shifty,-1,cyclic -add box_po.nc -mulc,9.81 box_zo.nc -add box_po.nc -mulc,9.81 box_zo.nc box_dlyv.nc -sin -mulc,0.017453 box_alat.nc box_ug-1.nc
...
cdo div box_ug_CDO.nc box_uko.nc ratio_u.nc
cdo div box_vg_CDO.nc box_vke.nc ratio_v.nc
